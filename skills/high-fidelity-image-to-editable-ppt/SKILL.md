...
The deterministic runtime traces chart and legend strokes from source pixels before cubic Bézier fitting, preserves source line-end markers, validates bracket families, enforces coordinate-axis clearance, performs object-level source-versus-render edge checks, vectorizes already separated icon assets to SVG/EMF, and applies cross-object collision constraints before build. These additions do not weaken the required source-faithful asset-sheet workflow.
