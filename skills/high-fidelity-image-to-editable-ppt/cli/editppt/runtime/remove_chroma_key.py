#!/usr/bin/env python3
"""Remove a solid chroma-key background from a high-fidelity-image-to-editable-ppt slide image.
...
def _dependency_hint(package: str) -> str:
    ...
    install_hint = "`pipx install --force --editable <path-to-high-fidelity-image-to-editable-ppt>/cli`"
    return (
