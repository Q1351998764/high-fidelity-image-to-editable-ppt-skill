#!/usr/bin/env python3
"""Unified CLI for high-fidelity-image-to-editable-ppt image generation or editing.
...
def _cli_reinstall_hint() -> str:
    return "`pipx install --force --editable <path-to-high-fidelity-image-to-editable-ppt>/cli`"
...
def _dependency_hint(package: str, *, upgrade: bool = False) -> str:
    ...
    return (
        "Install high-fidelity-image-to-editable-ppt with pipx so CLI dependencies are installed, for example "
...
asset sheets in high-fidelity-image-to-editable-ppt runs.
""",
