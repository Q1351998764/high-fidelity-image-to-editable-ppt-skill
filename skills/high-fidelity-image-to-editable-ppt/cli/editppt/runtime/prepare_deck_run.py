...
def main():
    parser = argparse.ArgumentParser(description="Create a stable high-fidelity-image-to-editable-ppt run directory.")
    parser.add_argument("inputs", nargs="+")
    parser.add_argument("--out-root", default="output/high-fidelity-image-to-editable-ppt")
